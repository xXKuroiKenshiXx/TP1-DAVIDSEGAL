...
import {AlertController,IonBackButton, IonButton,IonButtons,IonContent, IonFab, IonFabButton, IonFabList,IonHeader, IonIcon, IonInput, IonSearchbar,IonTitle,IonToolbar,ToastController} from '@ionic/angular/standalone';
...
import { colorGenerator } from 'src/utils';
import { MarcadorTemporal, Point } from 'src/interfaces';
...
export class GoogleMapsPage implements OnDestroy {
  ...
  constructor(private toastCtl: ToastController, private alertCtrl: AlertController) {
    addIcons({checkmark,search,add,location});
  }
